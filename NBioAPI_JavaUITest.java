...
public class NBioAPI_JavaUITest extends javax.swing.JDialog implements NBioBSPJNI.CAPTURE_CALLBACK {
    ...
    public int OnCaptured(NBioBSPJNI.CAPTURED_DATA capturedData){
    	...
    	System.out.println("Image Quality : " + capturedData.ImageQuality);
    	// If you do not return NBioAPIERROR_NONE, Capturing will be canceled.
    ...
    private Boolean SetWindowOption()
    {
        ...
        winOption.CaptureCallback = this;  
